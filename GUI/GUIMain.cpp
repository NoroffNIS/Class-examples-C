...
BEGIN_EVENT_TABLE(GUIDialog, wxDialog)
    EVT_CLOSE(GUIDialog::OnClose)
    EVT_BUTTON(idBtnQuit, GUIDialog::OnQuit)
    EVT_BUTTON(idBtnAbout, GUIDialog::OnAbout)
END_EVENT_TABLE()

GUIDialog::GUIDialog(wxDialog *dlg, const wxString &title)
